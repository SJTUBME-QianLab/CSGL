...
def build_args():
    ...
    parser.add_argument('--save_dir', default='./../sim_data/', type=str, help='Save directory')
    parser.add_argument('--y_dis', default='linear', type=str, choices=['linear', 'logistic'],
                        help='The distribution of Y')
    parser.add_argument('--cov', default='Laplacian', type=str, choices=['Gaussian', 'Laplacian'],
                        help='Covariance matrix')
    parser.add_argument('--rho', default=2.0, type=float, help='Coefficient for Laplacian')
